...
if __name__ == "__main__":
    ...
    try:
        # 示例用法
        print("加载数据...")
        reports_df = pd.read_csv(os.path.join(base_dir,"demo_data", 'pathology_ollama_embed_deepseek.csv'),
                                 ## phID as string
                                 dtype={'phID': str}, low_memory=False)
        cluster_qwen3 = pd.read_csv(
            os.path.join(base_dir, "deepseek_clustering_results/20260329_021547", 'clustered_data_simplified.csv'))
        ...
        training_results = joblib.load(os.path.join(model_dir, "training_results.pkl"))
